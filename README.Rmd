...
[Kiernan Nicholls][kn] (aka _k5cents_) during interactive R coding. Many these
functions offer simple  changes to bring commonly used functions more in line
with [tidyverse] style.
...
The `zip_*()` functions use `zip()` & `unzip()` but return data like `dir_ls()`.
